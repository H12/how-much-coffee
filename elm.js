...
{
	if (region.aY.ae === region.be.ae)
	{
		return 'on line ' + region.aY.ae;
	}
	return 'on lines ' + region.aY.ae + ' through ' + region.be.ae;
}
...
var author$project$Main$Drip = 0;
var author$project$Main$init = {W: 0, Z: 1.0, ab: 3.0};
...
var author$project$Main$creme = A3(mdgriffith$elm_ui$Element$rgb255, 231, 222, 205);
var elm$core$Basics$mul = _Basics_mul;
var author$project$Main$amount = F3(
	function (brewType, strength, _yield) {
		if (!brewType) {
			return _Utils_Tuple2((strength * _yield) * 15, _yield * 250);
		} else {
			return _Utils_Tuple2((strength * _yield) * 18, _yield * 250);
		}
	});
var author$project$Main$Press = 1;
var author$project$Main$SelectBrew = function (a) {
	return {$: 0, a: a};
};
var author$project$Main$brewToString = function (brew) {
	if (!brew.$) {
		if (!brew.a) {
			var _n1 = brew.a;
			return 'Drip';
...
var author$project$Main$brown = A3(mdgriffith$elm_ui$Element$rgb255, 128, 78, 73);
var author$project$Main$ternary = F3(
	function (isTrue, opt1, opt2) {
		return isTrue ? opt1 : opt2;
	});
var author$project$Main$white = A3(mdgriffith$elm_ui$Element$rgb255, 251, 250, 248);
...
var author$project$Main$statusAttrs = F2(
	function (isActive, color) {
		return _List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(
				A3(author$project$Main$ternary, isActive, color, author$project$Main$white)),
				mdgriffith$elm_ui$Element$Font$color(
				A3(author$project$Main$ternary, isActive, author$project$Main$white, color)),
...
var author$project$Main$trueCenter = _List_fromArray(
...
var mdgriffith$elm_ui$Internal$Style$classes = {b5: 'a', aH: 'atv', b8: 'ab', b9: 'cx', ca: 'cy', cb: 'acb', cc: 'accx', cd: 'accy', ce: 'acr', a4: 'al', a5: 'ar', cf: 'at', aI: 'ah', aJ: 'av', ch: 's', cl: 'bh', cm: 'b', co: 'w7', cq: 'bd', cr: 'bdt', an: 'bn', cs: 'bs', ao: 'cpe', cz: 'cp', cA: 'cpx', cB: 'cpy', z: 'c', aq: 'ctr', ar: 'cb', as: 'ccx', A: 'ccy', ad: 'cl', at: 'cr', cD: 'ct', cE: 'cptr', cF: 'ctxt', cQ: 'fcs', cR: 'fs', cS: 'g', aO: 'hbh', aw: 'hc', aP: 'hf', bl: 'hfp', cU: 'hv', cW: 'ic', cY: 'fr', c_: 'iml', c$: 'it', c0: 'i', T: 'nb', bw: 'notxt', dd: 'ol', df: 'or', L: 'oq', dk: 'oh', bB: 'pg', bC: 'p', dl: 'ppe', $7: 'ui', s: 'r', dq: 'sb', dr: 'sbx', ds: 'sby', dt: 'sbt', dv: 'e', dw: 'cap', dx: 'sev', dC: 'sk', a$: 't', dG: 'tc', dH: 'w8', dI: 'w2', dJ: 'w9', dK: 'tj', aE: 'tja', dL: 'tl', dM: 'w3', dN: 'w5', dO: 'w4', dP: 'tr', dQ: 'w6', dR: 'w1', dS: 'tun', bZ: 'ts', N: 'clr', dW: 'u', a0: 'wc', b2: 'we', a1: 'wf', b3: 'wfp', a2: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + mdgriffith$elm_ui$Internal$Style$classes.z);
...
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bB);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bC);
...
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dv);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.u)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dy.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dy.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.s) + ('-' + (elm$core$String$fromInt(pos.cC) + ('-' + (elm$core$String$fromInt(pos.aa) + ('-' + elm$core$String$fromInt(pos.S)))))));
		case 11:
	...
	[
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aH, mdgriffith$elm_ui$Internal$Style$classes.N)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aH, mdgriffith$elm_ui$Internal$Style$classes.L)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.ch) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.s) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.ch) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.ch) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.s) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.ch) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.aq) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {ap: closing, h: _List_Nil, E: _List_Nil, x: selector};
	});
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.x + ('{' + (renderValues(rule.E) + (rule.ap + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.dw + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.a$ + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.dw + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.a$)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {S: height / size, X: size, b0: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cw, adjustment.ck, adjustment.cH, adjustment.c1]);
	var lineHeight = 1.5;
				...
				switch (rule.$) {
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.s) + (' / ' + (elm$core$String$fromInt(position.s + position.S) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.cC) + (' / ' + (elm$core$String$fromInt(position.cC + position.aa) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.s) + ('-' + (elm$core$String$fromInt(position.cC) + ('-' + (elm$core$String$fromInt(position.aa) + ('-' + elm$core$String$fromInt(position.S)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dv))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.ch, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.aq, mdgriffith$elm_ui$Internal$Style$classes.A, mdgriffith$elm_ui$Internal$Style$classes.ce])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.ch, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.aq, mdgriffith$elm_ui$Internal$Style$classes.A, mdgriffith$elm_ui$Internal$Style$classes.cc])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.ch, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.aq, mdgriffith$elm_ui$Internal$Style$classes.cd])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.ch, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.aq, mdgriffith$elm_ui$Internal$Style$classes.cb])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.ch, mdgriffith$elm_ui$Internal$Style$classes.a$, mdgriffith$elm_ui$Internal$Style$classes.a0, mdgriffith$elm_ui$Internal$Style$classes.aw])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.ch, mdgriffith$elm_ui$Internal$Style$classes.a$, mdgriffith$elm_ui$Internal$Style$classes.a1, mdgriffith$elm_ui$Internal$Style$classes.aP])))
			]),
		_List_fromArray(
			[
...
var mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.bU : _Utils_ap(styled.bU, existingStyles)) : _Utils_Tuple2(
							A2(
								elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.cV, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.bU : _Utils_ap(styled.bU, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _n1.a;
			var styles = _n1.b;
			var newStyles = elm$core$List$isEmpty(styles) ? rendered.bU : _Utils_ap(rendered.bU, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.T, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.b5]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.T, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.cm]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.T, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.df]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.T, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.dd]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.T, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.cY]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.T, mdgriffith$elm_ui$Internal$Style$classes.dv, mdgriffith$elm_ui$Internal$Style$classes.cl]));
						}
					}())
				]),
			_List_fromArray(
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.bU);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						elm$core$List$cons,
						mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.as + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.A + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.dt + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bw)))))),
						A2(
							elm$core$List$cons,
...
var author$project$Main$brewButton = F2(
	function (selected, brew) {
		return A2(
			mdgriffith$elm_ui$Element$Input$button,
			A2(author$project$Main$statusAttrs, selected, author$project$Main$brown),
			{
				aR: A2(
					mdgriffith$elm_ui$Element$el,
					author$project$Main$trueCenter,
					mdgriffith$elm_ui$Element$text(
						author$project$Main$brewToString(
							elm$core$Maybe$Just(brew)))),
				de: elm$core$Maybe$Just(
					author$project$Main$SelectBrew(brew))
			});
	});
...
var author$project$Main$brewSelect = function (selectedBrew) {
	return A2(
		...
		_List_fromArray(
			[
				A2(author$project$Main$brewButton, !selectedBrew, 0),
				A2(author$project$Main$brewButton, selectedBrew === 1, 1)
			]));
};
var author$project$Main$gramsCoffee = function (amounts) {
	return elm$core$String$fromInt(
		elm$core$Basics$round(amounts.a)) + ' grams of coffee';
};
var author$project$Main$gramsWater = function (amounts) {
	return elm$core$String$fromInt(
		elm$core$Basics$round(amounts.b)) + ' grams of water';
};
var author$project$Main$SelectStrength = function (a) {
	return {$: 2, a: a};
};
var author$project$Main$strengthString = function (strength) {
	return (strength > 1.11) ? 'Strong' : ((strength > 0.89) ? 'Normal' : 'Weak');
};
...
var mdgriffith$elm_ui$Element$Input$slider = F2(
	function (attributes, input) {
		...
		var factor = (input.b_ - input.bu) / (input.bt - input.bu);
		var _n0 = input.bX;
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$min(
									elm$core$String$fromFloat(input.bu))),
								mdgriffith$elm_ui$Internal$Model$Attr(
								elm$html$Html$Attributes$max(
									elm$core$String$fromFloat(input.bt))),
								mdgriffith$elm_ui$Internal$Model$Attr(
								elm$html$Html$Attributes$value(
									elm$core$String$fromFloat(input.b_))),
...
var author$project$Main$strengthSlider = function (strength) {
	return A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$centerY,
							mdgriffith$elm_ui$Element$Background$color(author$project$Main$brown),
			...
			]),
		{
			aR: A2(
				...
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
					'Strength: ' + author$project$Main$strengthString(strength))),
			bt: 1.33,
			bu: 0.67,
			bz: author$project$Main$SelectStrength,
			bS: elm$core$Maybe$Nothing,
			bX: mdgriffith$elm_ui$Element$Input$defaultThumb,
			b_: strength
		});
};
var author$project$Main$SelectYield = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$yieldSlider = function (_yield) {
	return A2(
		mdgriffith$elm_ui$Element$Input$slider,
		_List_fromArray(
			[
			...
			]),
		{
			aR: A2(
				...
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
					'Yield: ' + (elm$core$String$fromFloat(_yield) + ' servings'))),
			bt: 5,
			bu: 1,
			bz: author$project$Main$SelectYield,
			bS: elm$core$Maybe$Just(0.1),
			bX: mdgriffith$elm_ui$Element$Input$defaultThumb,
			b_: _yield
		});
};
...
var author$project$Main$pageLayout = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$brewSelect(model.W),
				author$project$Main$strengthSlider(model.Z),
				author$project$Main$yieldSlider(model.ab),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[mdgriffith$elm_ui$Element$centerX]),
				mdgriffith$elm_ui$Element$text(
					author$project$Main$gramsCoffee(
						A3(author$project$Main$amount, model.W, model.Z, model.ab)))),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[mdgriffith$elm_ui$Element$centerX]),
				mdgriffith$elm_ui$Element$text(
					author$project$Main$gramsWater(
						A3(author$project$Main$amount, model.W, model.Z, model.ab))))
			]));
};
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{cQ: elm$core$Maybe$Nothing, cU: elm$core$Maybe$Nothing, c3: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.$7, mdgriffith$elm_ui$Internal$Style$classes.ch, mdgriffith$elm_ui$Internal$Style$classes.dv]))),
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(author$project$Main$creme),
				mdgriffith$elm_ui$Element$Font$family(
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Font$external(
						{c4: 'Source Sans Pro', dY: 'https://fonts.googleapis.com/css?family=Source+Sans+Pro'}),
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bg: fragment, bm: host, bD: path, bF: port_, bI: protocol, bJ: query};
	});
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{cZ: author$project$Main$init, dX: author$project$Main$update, dZ: author$project$Main$view});
